		...
		<div class="frame wit">
			<form class="write" action="" method="POST" enctype="multipart/form-data">
				<div class="write_flex">
					...
					<input type="text" name="name" placeholder="추가하려는 물고기의 이름을 입력" required autofocus>
				</div>
				<textarea name="content" rows="10" cols="170" style="resize: none; width: 1199px;" placeholder="추가하려는 물고기의 관련 설명을 입력"></textarea>
				<div class="bwt">
