...
<link href="https://fonts.googleapis.com/css2?family=Indie+Flower&family=Open+Sans:wght@300&display=swap" rel="stylesheet">
<meta charset="UTF-8">
<title>:::LOGIN:::</title>
<style>
	* {
...
<div class="main-img">
			<h1 style="text-align:left; margin-left:253px;margin-top:30px;">LOGIN</h1>
		</div>
	<div class="frame_mini">
